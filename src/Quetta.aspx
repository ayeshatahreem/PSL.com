<%@ Page Title="" Language="C#" MasterPageFile="~/PSL.Master" AutoEventWireup="true" CodeBehind="Quetta.aspx.cs" Inherits="PSL_WEBSITE.Quetta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView runat="server"
        ...
        DataSourceID="quetta_info" DataKeyNames="TeamID">
    ...
    <h3 style="margin-left:20%">PLAYERS</h3>
     <asp:GridView
        ...
        SortedAscendingCellStyle-Height="241px"
        Width="60%"
        AutoGenerateColumns="False" DataSourceID="QUE_palyers" DataKeyNames="PlayerID">
    ...
    <asp:SqlDataSource ID="quetta_info" runat="server" ConnectionString='<%$ ConnectionStrings:PSLConnectionString %>' SelectCommand="ViewTeamInfo" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:Parameter DefaultValue="5" Name="ID" Type="Int32"></asp:Parameter>
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="QUE_palyers" runat="server" ConnectionString='<%$ ConnectionStrings:PSLConnectionString %>' SelectCommand="ViewPlayerInfo" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:Parameter DefaultValue="5" Name="ID" Type="Int32"></asp:Parameter>
        </SelectParameters>
    </asp:SqlDataSource>
