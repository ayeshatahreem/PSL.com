<%@ Page Title="" Language="C#" MasterPageFile="~/PSL.Master" AutoEventWireup="true" CodeBehind="karachi.aspx.cs" Inherits="PSL_WEBSITE.karachi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView runat="server"
        ...
        DataSourceID="karachi_info" DataKeyNames="TeamID">
    ...
    <asp:GridView
        ...
        SortedAscendingCellStyle-Height="241px"
        Width="60%"
        AutoGenerateColumns="False" DataSourceID="KAR_palyers" DataKeyNames="PlayerID">
    ...
    <asp:SqlDataSource ID="karachi_info" runat="server" ConnectionString='<%$ ConnectionStrings:PSLConnectionString %>' SelectCommand="ViewTeamInfo" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:Parameter DefaultValue="2" Name="ID" Type="Int32"></asp:Parameter>
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="KAR_palyers" runat="server" ConnectionString='<%$ ConnectionStrings:PSLConnectionString %>' SelectCommand="ViewPlayerInfo" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:Parameter DefaultValue="2" Name="ID" Type="Int32"></asp:Parameter>
        </SelectParameters>
    </asp:SqlDataSource>
